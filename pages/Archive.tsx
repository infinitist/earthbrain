...
const VideoCard: React.FC<{ video: VideoItem }> = ({ video }) => {
  ...
  return (
    <div className="group block">
      ...
      {/* Transcript Button and Content - Outside the link */}
      {video.transcript && (
        <div className="mt-4">
          <button
            onClick={() => setShowTranscript(!showTranscript)}
            className="w-full text-sm font-medium text-emerald-700 hover:text-emerald-900 px-6 py-3 rounded-full border border-emerald-200 hover:border-emerald-400 transition-all bg-white hover:bg-emerald-50"
          >
          ...
          {showTranscript && (
            <motion.div
              ...
              className="mt-4 p-6 bg-emerald-50 rounded-2xl border border-emerald-100"
            >
