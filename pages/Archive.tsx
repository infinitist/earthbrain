...
const Archive: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="pt-32 pb-20 px-6 bg-slate-50 border-b border-emerald-100 text-center">
          ...
          <div className="mt-20 flex flex-wrap justify-center gap-3">
            {categories.map(cat => (
              <button
                ...
                className={`px-10 py-5 rounded-full text-[10px] font-black uppercase tracking-[0.4em] transition-all duration-500 shadow-sm ${
                  activeCategory === cat 
